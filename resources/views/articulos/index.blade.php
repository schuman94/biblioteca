                    ...
                    <aside class="flex flex-col items-center w-1/4">
                        ...
                        <div class="flex">
                            ...
                            <form method="POST" action="{{ route('comprar') }}">
                                @csrf
                                <button type="submit"
                                    class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Comprar</button>
                            </form>
                        </div>
                    </aside>
                @endif
